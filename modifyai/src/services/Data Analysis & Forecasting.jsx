...
const benefits = [
    ...
    "Reduce costs by identifying inefficiencies and optimization opportunities through data insights.",
  ...
  return (
    <section className={`w-full py-20 px-4 ${theme === "dark" ? "bg-gray-900" : "bg-gray-100"}`}>
      ...
      {/* Content and Image Container */}
      <div className="max-w-7xl max-h-5xl mx-auto flex flex-col md:flex-row gap-12 items-stretch">
                  {/* Left: Image/Illustration */}
          <div className="flex-1 flex items-stretch justify-center">
            <div className="relative p-2 h-full">
              <img src={agentImg} alt="Data Analysis Tools" className="w-full h-full object-contain rounded-2xl shadow-xl relative z-10" />
              {/* Clean border only */}
